        ...
        bluetoothIn = new Handler() {
            public void handleMessage(android.os.Message msg) {
                ...
                if (msg.what == handlerState) {          //if message is what we want
                    ...
                    if (endOfLineIndex > 0) {
                        System.out.println(recDataString);// make sure there data before ~
                        ...
                        {
                            String sensor0 = recDataString.substring(1, 1);             //get sensor value from string between indices 1-5
                            String sensor1 = recDataString.substring(1, 1);            //same again...
                            String sensor2 = recDataString.substring(1, 1);
                            String sensor3 = recDataString.substring(1, 1);
